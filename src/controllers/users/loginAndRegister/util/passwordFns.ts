 ...
 *
 * Creates an abstraction over the argon2.hash method, in the case that the manner in which I choose
 * to hash passwords changes.
 */
 ...
 *
 * Creates an abstraction over the argon2.hash function, in the case that the manner in which I
